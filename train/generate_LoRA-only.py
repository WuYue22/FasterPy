...
# 第一步：加载 LoRA 的配置
peft_model_path = "output-src-cl/checkpoint-1112"
config = PeftConfig.from_pretrained(peft_model_path)
model_id="model/codellama-7b-instruct"
...
def infer(row):
    ...
    prompt = input_template.substitute(input=input)
    messages = [
...
torch.cuda.empty_cache()
df.to_json("cl-lora-cost.jsonl",lines=True,orient='records')
